    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Hakkımızda</h1>
                ...
                if (!empty($_POST)){
                    ...
                    $id = 1;
                        ...
                        $query = $pdo->prepare("UPDATE hakkimizda SET baslik=:hbaslik,icerik=:hicerik WHERE id=:hid");
                        $query->execute([
                            "hbaslik"=>$baslik,
                            "hicerik"=>$icerik,
                            "hid"=>$id,
                        ...
                        echo "<script>location.href='hakkimizda.php';</script>";
                ...
                ?>
                 ...
                 <div>
                     <form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>">
                         <input type="text" name="baslik" placeholder="Başlık Giriniz..." value="<?php echo $data["baslik"] ?>" class="p-2 w-75 mb-4">
                         <textarea name="icerik" id="editor"><?php echo $data["icerik"] ?></textarea>
                         <input type="submit" value="Kaydet" class="btn btn-primary my-2">
                     </form>
                 </div>
