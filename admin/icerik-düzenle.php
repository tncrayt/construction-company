    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">İçerik Düzenle</h1>
                <?php
                if (!empty($_POST)){
                    ...
                    if ($_FILES["resim"]["size"]==0){
                        $query= $pdo->prepare("UPDATE yazilar SET baslik=:baslik,icerik=:icerik WHERE id=:id ");
                        $query->execute([
                            "baslik"=>$baslik,
                            "icerik"=>$icerik,
                            "id"=>$id
                        ...
                        $query= $pdo->prepare("UPDATE yazilar SET baslik=:baslik,icerik=:icerik,yazi_resim=:yazi_resim WHERE id=:id ");
                        $query->execute([
                            "baslik"=>$baslik,
                            "icerik"=>$icerik,
                            "yazi_resim"=>$yol,
                    ...
                    echo "<script>location.href='icerik-goster.php'</script>";
                ...
                <?php
                    if (isset($_GET["id"])){
                        $id = $_GET["id"];
                        $query= $pdo->prepare("SELECT * FROM yazilar WHERE id=:id");
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <form method="post" enctype="multipart/form-data">
                                <input type="text" value="<?php echo $data["baslik"]; ?>" name="baslik" placeholder="Başlık Giriniz..." class="p-2 w-100 mb-4">

                                <div class="card mb-2">

                                    <img src="<?php echo "../".$data["yazi_resim"]; ?>" class="img-thumbnail" id="resim_goster"  data-fancybox="gallery" style="height: 150px;width: 150px;object-fit: cover">
                                    <input type="file" id="slider_resim" name="resim" class="mb-4" accept="image/*">

                                </div>

                                <textarea id="editor" name="icerik"><?php echo $data["icerik"]; ?></textarea>
